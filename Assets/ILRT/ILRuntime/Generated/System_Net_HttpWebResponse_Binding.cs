...
{
    unsafe class System_Net_HttpWebResponse_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Net.HttpWebResponse);
            args = new Type[]{};
        ...
        static StackObject* get_StatusCode_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Net.HttpWebResponse instance_of_this_method = (System.Net.HttpWebResponse)typeof(System.Net.HttpWebResponse).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
